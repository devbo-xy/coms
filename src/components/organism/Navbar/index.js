...
export const Navbar = () => {
  ...
  return (
    <>
      <div
        className="w-full nav z-[100] top-0 fixed md:static  md:h-auto"
        style={{ transition: "0.5s" }}
      >
        <div className="z-[10]  w-full before:-z-[1] before:absolute before:w-full before:h-full bg-white py-3 transition">
          {/* <div className="relative hidden max-w-5xl mx-auto cursor-pointer md:block top-2"></div> */}
